...
const limiter = rateLimit({
  ...
  max: 2400, // limit each IP to 100 requests per windowMs ----- changed to 500
  message: {
    success: false,
...
app.use("/api/push", [...middleware, require("../routes/push")]);
app.use("/api/slots", [...middleware, require("../routes/slots")]);
...
app.use("/api/callback/pragmaticslot", [...middleware, require("../routes/pragmaticslot")]);
