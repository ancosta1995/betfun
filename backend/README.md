# betbasegg Gambling Website v2

betbasegg website uses MERN-stack and provides a JSON REST API for clients.
...
For server is required to open port `2053 on firewall`