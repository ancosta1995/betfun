...
export const API_URL =
  ...
  // ? "https://betfun.gg:2053/api"
  // : "https://betfun.gg:2053/api";
  ? 'http://localhost:2053/api'
  : "https://betfun.gg:2053/api";
...
export const RECAPTCHA_SITE_KEY = "6Ldw--0nAAAAADtstlbkunOC2kbAFfzdSMewOcAX";
...
export const getUserTxData = async () => {
  return new Promise(async (resolve, reject) => {
    try {
      const response = await API.get("/user/txs");
      resolve(response.data);
    } catch (error) {
      reject(error);
    }
...
export const getUserInviData = async () => {
  return new Promise(async (resolve, reject) => {
    try {
      const response = await API.get("/user/invi");
      resolve(response.data);
    } catch (error) {
      reject(error);
    }
...
export const getUserDepositInformation = async () => {
  return new Promise(async (resolve, reject) => {
    try {
      const response = await API.get("/cashier/crypto/wallet");
      resolve(response.data);
    } catch (error) {
      reject(error);
    }
...
export const withdrawCryptomain = async (currency, address, amount, network) => {
  try {
...
// Withdraw crypto to personal wallet
export const withdrawCrypto = async (currency, address, amount, network) => {
  return new Promise(async (resolve, reject) => {
    try {
      const response = await API.post("/cashier/crypto/withdraw", {
        currency,
...
// Withdraw crypto to personal wallet
export const SaveCurrency = async (FiatCurrency, Currency, DisplayInFiat ) => {
  return new Promise(async (resolve, reject) => {
    try {
      const response = await API.post("/mines/savecurrency", {
        FiatCurrency,
        Currency,
        DisplayInFiat,
      });
...
export const GetCurrency = async () => {
  return new Promise(async (resolve, reject) => {
    try {
      const response = await API.get("/mines/currencysettings");
      resolve(response.data);
    } catch (error) {
      reject(error);
    }
...
export const Notificationn = async () => {
  return new Promise(async (resolve, reject) => {
    try {
      const response = await API.get("/push/notifications"); // Ensure this is the correct path
      resolve(response.data);
    } catch (error) {
      reject(error);
    }
...
export const getActiveGame = async (gameId) => {
  return new Promise(async (resolve, reject) => {
    try {
      const response = await API.post("/battles/game",
      {
        gameId
      });
      resolve(response.data);
...
export const getActiveMines = async () => {
  return new Promise(async (resolve, reject) => {
    try {
      const response = await API.get("/mines/me");
      resolve(response.data);
    } catch (error) {
      reject(error);
    }
...
export const Getminesreveal = async () => {
  return new Promise(async (resolve, reject) => {
    try {
      const response = await API.get("/mines/reveal");
      resolve(response.data);
    } catch (error) {
      reject(error);
    }
...
export const getLastOpen = async () => {
  return new Promise(async (resolve, reject) => {
    try {
      const response = await API.get("/cases/lastopen");
      resolve(response.data);
    } catch (error) {
      reject(error);
    }
...
export const getAllcases = async () => {
  return new Promise(async (resolve, reject) => {
    try {
      const response = await API.get("/battles/amount");
      resolve(response.data);
    } catch (error) {
      reject(error);
    }
...
// Claim an kinguin giftcard code
export const claimGiftcardCode = async code => {
  return new Promise(async (resolve, reject) => {
    try {
      const response = await API.post("/kinguin/redeem", {
        code,
      });
      resolve(response.data);
    } catch (error) {
...
export const getCase = async (slug) => {
  return new Promise(async (resolve, reject) => {
    try {
      const response = await API.post("/battles/case", { slug });
      resolve(response.data);
    } catch (error) {
      reject(error);
    }
...
export const createDepositSession = async (username, GrowID, user_id, gameCode, token) => {
  return new Promise(async (resolve, reject) => {
    try {
...
export const getCurrentSeedPair = async () => {
  return new Promise(async (resolve, reject) => {
    try {
      const response = await API.get("/provably-fair/current");
      resolve(response.data);
    } catch (error) {
      reject(error);
    }
...
export const updateClientSeed = async (newClientSeed) => {
  return new Promise(async (resolve, reject) => {
    try {
      const response = await API.post("/provably-fair/update-seed" , { newClientSeed });
      resolve(response.data);
    } catch (error) {
      reject(error);
    }
...
export const getSeedPairHistory = async () => {
  return new Promise(async (resolve, reject) => {
    try {
      const response = await API.get("/provably-fair/history");
      resolve(response.data);
    } catch (error) {
      reject(error);
    }
