  ...
  return (
    <Box className={classes.root}>
      <Container className={classes.container}>
        ...
        <section>
          <p>
            This end user agreement (the "Agreement") should be read by you (the "User" or "you") in its entirety prior to your use of betfun.gg's service or products. Please note that the Agreement constitutes a legally binding agreement between you and betfun.gg (referred to herein as "betfun.gg", "us" or "we") which owns and operates the Internet site found and games described at betfun.gg (the "Service"). By clicking the "Accept Terms" button if and where provided and/or using the Service, you consent to the terms and conditions set forth in this Agreement.
            <br /><br />
        ...
        <section>
          ...
          <p>
            <span className={classes.counterup}>1.1.</span> betfun.gg grants you a limited, non-transferable, royalty-free license to use the Service in accordance with the terms of this agreement.
          </p>
          <p>
        ...
        <section>
          ...
          <p>
            <span className={classes.counterup}>2.2.</span> Persons located in or residents of the United States, Australia, Aruba, Bonaire, Curaçao, Cyprus, France, Netherlands, Saba, Statia, Iran, or St Martin (the ”Prohibited Jurisdictions”) are not permitted to make use of the Service. For the avoidance of doubt, the foregoing restrictions on engaging in real-money play from Prohibited Jurisdictions applies equally to residents and citizens of other nations while located in a Prohibited Jurisdiction. Any attempt to circumvent the restrictions on play by any persons located in a Prohibited Jurisdiction or Restricted Jurisdiction, is a breach of this Agreement. An attempt at circumvention includes, but is not limited to, manipulating the information used by betfun.gg to identify your location and providing betfun.gg with false or misleading information regarding your location or place of residence.
          </p>
          <p>
            <span className={classes.counterup}>2.3.</span> betfun.gg may not be used for illegal or unauthorized purposes and you must abide completely by the laws, rules, and regulations that apply to you. Whether that be federal, state, or local laws.
          </p>
        </section>
        <section>
          <b>3. LIMITATIONS AND LIABILITY.</b>
          <p>
            <span className={classes.counterup}>3.1.</span> You understand and agree to defend, indemnify and hold no liability or accountability to betfun.gg, its licensors, licensees, distributors, agents representatives and other authorized users, and all of the foregoing entities' respective officers, directors, owners, employees, agents, representatives, and assigns from and against any and all claims, damages, obligations, losses, liabilities, costs, attorneys’ fees, and expenses in the occasion of or in connection with, your use of the website, your violation construed to the terms of service, the sale, purchase or use of any items, your violation of any third party right, including but not limited to copyright, trademark or privacy right and any submittance by you that causes damage to a third party. You are expected to participate and cooperate to whatever extent required in the defence of any claim. betfun.gg reserves the right to assume the exclusive defence and control of any matter otherwise subject to indemnification by you. You will not discuss or enter any settlement agreement that affects the rights of betfun.gg without betfun.gg's written permission.
          </p>
        </section>
        <section>
          <b>4. USER SUBMITTED CONTENT.</b>
          <p>
            <span className={classes.counterup}>4.1.</span> You understand that you own all intellectual property rights in any user submitted content or that you have the applicable rights and or permissions from the owner of the content. By submitting user submitted content to the website you automatically allow permission for betfun.gg to a worldwide, perpetual, irrevocable royalty free transferable right and license to use, copy, modify adapt, publish, translate, create derivative works, and distribute your user submitted content.
          </p>
          <p>
            <span className={classes.counterup}>4.2.</span> betfun.gg is not liable for any user submitted content or third party content displayed or submitted to the website.
            <br /><br />
            If you believe that any content on the website breaches your copyright, trademarks, or other intellectual property right please send a written notification of your claim to betfun.gg via Live Chat Ticket or Discord.
          </p>
        </section>
        <section>
          <b>5. RELATIONSHIP OF PARTIES.</b>
          <p>
            <span className={classes.counterup}>5.1.</span> No joint venture, employment or agency exists between you and betfun.gg and nothing in these terms of use will be interpreted as creating any type of joint venture, employment or partnership.
          </p>
        </section>
        <section>
          <b>6. PAYMENTS AND FEES</b>
          <p>
            <span className={classes.counterup}>6.1.</span> You the user comprehends that you are the owner of any cryptocurrency address or accounts you use on betfun.gg services. You understand and agree that any billing information that you provide to betfun.gg may be passed on by betfun.gg to companies working in line with or on betfun.gg behalf such as payment processors and/or credit agencies solely for the purposes of effecting payment to betfun.gg and Sellers.
          </p>
          <p>
            <span className={classes.counterup}>6.2.</span> You agree that betfun.gg is not liable for the actions for any third-party payment processors and, on any dispute resulting from the third-party payment processor such as payment holds, you agree to resolve your dispute directly with them.
          </p>
          <p>
            <span className={classes.counterup}>6.2.</span> You agree that betfun.gg is not liable for the actions for any third-party payment processors and, on any dispute resulting from the third-party payment processor such as payment holds, you agree to resolve your dispute directly with them.
          </p>
          <p>
            <span className={classes.counterup}>6.3.</span> On the occasion that a buyer on the site receives a refund through a third-party payment processor used by betfun.gg the Buyer shall abide by betfun.gg to pay any applicable transaction fees involved. Also including any further fees or charges imposed by third parties by the use of external services related to the transaction.
          </p>
        </section>
        <section>
          <b>7. KNOW YOUR CUSTOMER.</b>
          <p>
            <span className={classes.counterup}>7.1.</span> betfun.gg reserves the right, at any time, to request KYC documentation it deems necessary to determine the identity and location of a User. betfun.gg reserves the right to restrict service and payment until identity is sufficiently determined.
          </p>
        </section>
        <section>
          <b>8. SEVERABILITY.</b>
