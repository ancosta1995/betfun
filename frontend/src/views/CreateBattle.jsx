...
root: {
  ...
  battleCreatorControl: {
    ...
    marginTop: "24px",
    paddingTop: "18px",
    borderTop: "2px dashed #0a0b1c",
    borderBottom: "2px dashed #0a0b1c",
    fontFamily: "Rubik",
  },
  ...
  buttonAdd: {
    ...
    fontWeight: 500,
    color: "#effafb",
    background: "linear-gradient(225deg,#1C2344 30%,#0a0b1c),#2a2a38",
    border: "none",
  ...
  modalBody: {
    ...
    borderLeft: "6px solid #050614 !important",
    borderRight: "6px solid #050614 !important",
    borderBottom: "6px solid #050614 !important",
    position: "relative",
    flex: "1 1 auto",
    fontFamily: "Rubik",
    padding: "1rem",
  ...
  casePrice: {
    ...
    padding: "0 16px",
    borderRadius: "4px",
    background: "linear-gradient(225deg, rgba(77, 55, 99, 0) 50%, rgb(0 0 0 / 8%)), hsl(208.95deg 37.65% 24.77% / 11%)",
    boxShadow: "0 2px 16px rgba(0,0,0,.24)",
  },
  casePriceWrapper: {
    fontSize: "15px",
  ...
  selectedCase: {
    background: "linear-gradient(225deg,#050614 30%,#050614),#050614",
...
const CreateBattle = ({ user, isAuthenticated }) => {
  ...
  const renderCaseOptions = () => {
      ...
      allBoxes.push(
        filteredCases.map((item, i) => (
          <div className={`${classes.battleCreatorCase} ${selectedCases.find(e => e.id === item.id) ? classes.selectedCase : ""}`} key={item.id} >
            <a href={'https://betfun.gg/cases/' + item.slug} target="_blank" rel="noopener noreferrer">
    ...
    <div className={classes.casePriceWrapper}>
        ...
        <div className={classes.fixedpricewrapper}>

        <img src="https://i.ibb.co/LxpnfZP/dl-2a39d38a.webp" alt="Case Cost" width="15" height="15" style={{ marginLeft: '5px'}} />
        </div>
...
Cost <div className={classes.priceWrapper}>${totalCost.toFixed(2)}</div>
                </Typography>
              </div>
