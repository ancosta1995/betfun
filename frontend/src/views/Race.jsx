...
const renderer = ({ days, hours, minutes, seconds, completed }) => {
  if (completed) {
    ...
    return (
      <span style={{ margin: "0" }}>
        NOW! PRIZES WILL BE CREDITED SHORTLY..
      </span>
    );
  } else {
    // Render a countdown
    ...
    return (
      <span>
        {days}d - {z(hours)}h - {z(minutes)}m - {z(seconds)}s
      </span>
    );
  }
};
