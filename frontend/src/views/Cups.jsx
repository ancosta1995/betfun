...
const useStyles = makeStyles(theme => ({
  ...
  controls: {
    ...
    maxWidth: "1260px", // Set the maximum width to maintain consistency
    marginLeft: "auto",
    marginRight: "auto",

    marginTop: "50px",
    padding: "2rem 2rem", /* top/bottom: 2rem, right/left: 2rem */
    paddingTop: "2rem",
    borderBottom: "2px solid #101123",
    margin: "0 auto", /* Center the controls block horizontally */
    borderRadius: "10px", /* Adding border radius */
    transition: "transform 0.3s, filter 0.3s", /* Adding transition for smooth hover effect */
    [theme.breakpoints.down("sm")]: {
      width: "calc(100%)",
      background: "#101123",
      borderBottom: "0px",
      ...
      paddingTop: "3rem",
      display: "grid",
      borderRadius: "0", /* Resetting border radius for smaller screens */
    },
    "&:hover": {
