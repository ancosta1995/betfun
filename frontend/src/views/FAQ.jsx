    ...
    <Box className={classes.root}>
      <Container className={classes.container}>
        ...
        <section>
          ...
          <p>
            You can join our <a className={classes.a} href="https://discord.gg/betbase" target="_blank" rel="noreferrer">
              Discord
            </a> server and open a support ticket, or contact us at support@betfun.gg
          </p>
        </section>
        <br />
        <section>
        ...
        <section>
          ...
          <p>
            Simply wager and play on betfun.gg! Once you have wagered, you have
