...
import betbaseggbanner from "../assets/jackpotbanner.png";
        ...
        <Container className={classes.container}>
            ...
            >
              <Carousel.Item>
                <a
                  ...
                  href="https://discord.gg/betbasegg"
                  target="_blank"
          ...
          {isLoading ? (
            ...
            <Box className={classes.games}>
              ...
              <Box className={classes.game}>
                <img alt="Coinflip" className={classes.gamesimages} src={betbaseggbanner} />
              </Box>
              <Box className={classes.game}>
