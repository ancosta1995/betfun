  ...
  return (
      ...
      >    
        ...
        <div className={classes.content} >
          <div style={{display: "flex", gap: "0.5rem", color: "#fff"}}><span style={{color: "#838b8d"}}>Open a support ticket in our</span><a style={{color: "#fff"}} href="https://t.me/solanaspin">Discord</a></div>
