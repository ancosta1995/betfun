...
const useStyles = makeStyles(theme => ({
  ...
  withdraw: {
    ...
    fontWeight: 500,
    letterSpacing: ".1em",
    backgroundColor: "#5201f9 !important",
    width: "100%",
    marginTop: "1rem",
    height: "3rem",
  },
  ...
  return (
    <Box className={classes.root}>
      ...
      { /*  <Box className={classes.cryptocolor}>
          Withdraw your desired amount of Dls (Dls).
          <br />
          Minimum withdraw amount is <span style={{ color: "#FFC440", }}>1 Diamond Lock</span>
        </Box>*/}
        <li>Type in your Growtopia GrowID that you would like to withdraw with, then press 'Start Withdraw'.</li>
        <li>Wait for the loading to complete (it may take up to 30 seconds).</li>
        <li>Enter the generated world in Growtopia.</li>
        <li>Wait for the bot to drop your <img src="https://growdice.co/assets/wl-b3d08b52.webp" width="18" height="18" className="sc-x7t9ms-0 dnLnNz" /> / <img src="https://growdice.co/assets/dl-2a39d38a.webp" width="18" height="18" className="sc-x7t9ms-0 dnLnNz" /> / <img src="https://growdice.co/assets/bgl-e2c76d7e.webp" width="18" height="18" className="sc-x7t9ms-0 dnLnNz" />  and pick them up.</li>
        <li>If you encounter any issues, message  <a target="_blank" className="text-white" href="/discord">support</a>.</li>
