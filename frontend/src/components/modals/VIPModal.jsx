...
const useStyles = makeStyles(theme => ({
  ...
  rake: {
    ...
    padding: "10px",
    width: "200px", /* Adjust width to make it wider */
    height: "50px", /* Adjust height to make it taller */
...
const Vip = ({ open, handleClose, changeWallet, user }) => {
  ...
  return (
    ...
    >
      ...
      <DialogActions style={{ background: "#101123", }}>
