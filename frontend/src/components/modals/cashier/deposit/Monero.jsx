...
import solana from "../../../../assets/cashier/solana.png";
...
const Solana = ({ open, handleClose }) => {
  ...
  const copyAddress = () => {
    const address = cryptoData.xmr.address;
      ...
      <div className={classes.modal}>
        <div className={classes.titleBox} onClose={handleClose} >
          <div style={{fontSize: "1.5rem", color: "#E0E4EB", display: "flex", alignItems: "center", gap: "0.5rem" }}>
            <img src={Solana} style={{height: 30, width: 30}} />
            Solana Deposit
          </div>
        </div>
        <div className={classes.content} >
          <div className={classes.addressContainer}>
            ...
            <div style={{width: "100%"}}>
              ...
              {loading ? "null" : cryptoData.xmr.address.length > 35 ? cryptoData.xmr.address.substring(0, 35) + "... (copy to get whole address)" : cryptoData.xmr.address}
          ...
          <div style={{display: "flex", flexDirection: "column", justifyContent: "center", alignContent: "center", marginTop: "1rem", marginBottom: "1rem"}}>
            <div className={classes.warningContainer}>
              Only deposit on the SOL Network!
            </div>
          </div>
        </div>
      </div>  
